...
function Home() {
  ...
  <div className="relative overflow-hidden py-10">
    ...
    {/* Fading Edge Mask */}
    <div className="pointer-events-none absolute inset-y-0 left-0 w-48 bg-gradient-to-r from-[#fafafa] to-transparent z-10" />
    <div className="pointer-events-none absolute inset-y-0 right-0 w-48 bg-gradient-to-l from-[#fafafa] to-transparent z-10" />
  </div>
</section>
